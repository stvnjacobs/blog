...
- name: rsync
  ...
  description: "moves the changed and newly created files for the site from my computer to the server."
  tags:
  resources:
...
- name: Bower
  link: http://bower.io
  description: "keeps any third party libraries I use seperate and kept up to date."
  tags: 
  resources: 
```
